...
for (k in 94:104) {
  ...
  assign(Ex_dividend_File,read.csv(getStockNumED_path,fileEncoding="UTF-8",stringsAsFactors = FALSE,header = FALSE))
}
#最後一個即可
colnames(Ex_dividend.94)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.95)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.96)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.97)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.98)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.99)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.100)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.101)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.102)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
colnames(Ex_dividend.103)<-c("num","ID","name","dividend_Y","basicDate","dividend_S_Earnings","dividend_S_Law","dividend_S_Date","employee_S1","employee_S2","employee_S3","employee_S4","dividend_C_Earnings","dividend_C_Law","dividend_C_Date","dividend_C_PaymentDate","employee_C_total","CashCapitalIncrease_S","CashCapitalIncrease_Rate","CashCapitalIncrease_Price","DS_C","Announcement_Date","Announcement_Time","Denomination_Shares")
  ...
  for (year in 94:104) {
    ...
    for (j in 1:nrow(get(paste("Ex_dividend",year,sep=".")))) {#待檔案筆數
      if (get(paste("Ex_dividend",year,sep="."))[j,2]==getNum) {#找相同代號
        ...
        if(l>0){#已有資料
          assign(getNumFile,rbind(get(getNumFile),get(paste("Ex_dividend",year,sep="."))[j,],deparse.level = 0))
